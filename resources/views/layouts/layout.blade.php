...
<body>
    ...
    <!-- Product OVERVIEW INSIDE and other content (slider banner product)  -->
    <div class="content">
        @yield('content')
    </div>
        ...
        <div class="container">
            ...
            <div class="p-t-40">
                ...
                <p class="stext-107 cl6 txt-center">
                    Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Made with <i class="fa fa-heart-o" aria-hidden="true"></i> by TA KI &amp; distributed by THIEVES
                </p>
            </div>
        </div>
    </footer>
